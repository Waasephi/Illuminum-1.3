...
namespace Illuminum.UI
{
	internal class SoulResourceBar : UIState
	{
		...
		public override void OnInitialize()
		{
			...
			barFrame = new UIImage(ModContent.GetTexture("Illuminum/UI/SoulResourceFrame"));
			...
			gradientA = new Color(7, 5, 71); // A dark purple
			gradientB = new Color(79, 237, 255); // A light purple
		...
		public override void Draw(SpriteBatch spriteBatch)
		{
			...
			if (!(Main.LocalPlayer.HeldItem.modItem is ConjuristItem))
				return;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			var modPlayer = Main.LocalPlayer.GetModPlayer<ConjuristPlayer>();
			// Calculate quotient
		...
		public override void Update(GameTime gameTime)
		{
			...
			text.SetText($"Soul: {modPlayer.soulResourceCurrent} / {modPlayer.soulResourceMax2}");
