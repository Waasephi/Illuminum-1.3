...
namespace Illuminum.NPCs.Bosses.FrigidConstruct
{
    [AutoloadBossHead]
    public class FrigidConstruct : BaseNPC
    {
        ...
        {
            DisplayName.SetDefault("Frigid Construct");
        ...
        public override void SetDefaults()
        {
            ...
            bossBag = mod.ItemType("FrigidConstructTreasureBag");
        ...
        public override void NPCLoot()
        {
            if (!Main.expertMode)
            {
                ...
                {
                    case 0:
                        Item.NewItem(npc.getRect(), mod.ItemType("FrigidConstructMask"), 1);
                        break;
                }
            }
            {
                ...
                switch (loots2)
                {
                    case 1: Item.NewItem(npc.getRect(), mod.ItemType("FrigidConstructTrophy"), 1); break;
                    case 2: break;
                }
            }
            IlluminumWorld.downedFrigidConstruct = true;
            if (Main.expertMode)
            {
                npc.DropBossBags();
            }
