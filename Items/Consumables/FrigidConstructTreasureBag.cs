...
{
	public class FrigidConstructTreasureBag : ModItem
	{
		...
		public override void OpenBossBag(Player player)
		{
			...
			{
				player.QuickSpawnItem(ModContent.ItemType<FrigidConstructMask>());
			}
		...
		public override int BossBagNPC => ModContent.NPCType<NPCs.Bosses.FrigidConstruct.FrigidConstruct>();
	}
}