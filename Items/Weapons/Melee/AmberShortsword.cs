...
namespace Illuminum.Items.Weapons.Melee
{
	public class AmberShortsword : ModItem
	{
		...
		{
			 DisplayName.SetDefault("Amber Shortsword"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
		}
		...
		public override void SetDefaults() 
		{
			...
			item.shoot = ProjectileType<AmberShortswordProjectile>();
		}
